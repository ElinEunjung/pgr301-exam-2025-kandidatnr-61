...
NB: Rett før innlevering la jeg utilsiktet inn en Permissions Boundary i IAM-konfigurasjonen min. Jeg har ikke nødvendige rettigheter til å fjerne denne selv, og den hindrer `terraform init` i å kjøre. Jeg ber derfor om at boundary slettes før oppgaven gjennomgås, slik at Terraform-koden kan valideres som forventet.
